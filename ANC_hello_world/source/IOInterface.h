...
typedef struct{
	q15_t noiseSample,musicSample,errMicSample;
}InputMeasure;
...
void pushOutput(q15_t output); //Pushes to an output queue, then this layer puts it in the DAC at the correct time.
